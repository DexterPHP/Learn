...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
            ...
            <div class="navbar-header TopRight">
                ...
                <a class="navbar-brand coursat-logo-main" href="/" ><img style="margin-right: -6px;" src="{{asset('images/logo.png')}}"  alt="كورسات" /></a>
                <a class="navbar-brand coursat-logo-mobile" href="/"><img src="{{asset('images/logo-mobile.png')}}" alt="كورسات" /></a>
            </div>



            <div class="collapse navbar-collapse" id="ourNavbar" style="margin-top: -3px;">
                ...
                <ul class="nav navbar-nav navbar-left " style=" position: absolute; top: -3px; left: 13%; " >
